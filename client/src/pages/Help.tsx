...
const Help = () => {
  return (
      ...
      className="w-screen bg-none mt-12 mb-12 text-left">
        <main
        className="container mx-auto bg-none p-4 rounded-md flex flex-col gap-4 items-center">
        <h1>How it Works</h1>
        <div>
            <div className="flex flex-col justify-between m-2 md:flex-row lg:flex-row">
                
                <div className="flex flex-col gap-4  w-fit m-2 h-fit justify-center items-center text-left max-w-xlg md:w-1/2 lg:w-1/2">
                ...
                <p className="">
                    ...
                    If you enjoy this project, consider connecting with me on to stay up-to-date on my other work.
                </p>
                </div>

                <div className="flex justify-center items-center">
                    <img src="/description.jpg" height={500} width={500} />
                </div>
            </div> 
            <div className="flex flex-col justify-between m-2 md:flex-row lg:flex-row">
                ...
                <div className="flex justify-center items-center">
                <img src="/solution.jpg" height={500} width={500} />
